...
public class Spoon extends Dish {
	...
	public Spoon(String material, String color, boolean isDecorative) {
		super(material, color, isDecorative);
	}

	public Spoon(String material, String color, int width, int height, float depth, boolean isDecorative) {
	...
	public void uniqueSpoonMethod() {
		System.out.println("Method unique to objects of 'Spoon' class");
	}
