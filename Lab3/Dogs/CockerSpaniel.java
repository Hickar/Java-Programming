...
public class CockerSpaniel extends Dog {
	...
	private String uniqueBark = "Af-aaf!";

	public CockerSpaniel() {};

	public CockerSpaniel(String name, int age) {};

	public CockerSpaniel(String name, int age, String color, String size) {};
	...
	public String toString() {
		return "["+name+"]: Cocker Spaniel, "+age+", "+color+", "+size;
	}
}
